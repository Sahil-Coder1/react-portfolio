...
const Testimonial = () => {
    return(
        ...
        <p data-aos="fade-up" className='desc'>Below are a selection of clients I've had the pleasure of working with, accompanied by testimonials from a few of them.</p>
